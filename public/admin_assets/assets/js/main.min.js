            ...
            this.refreshSize(),
              a > this.top && this.isWrap
                ? ((this.height = i[0].offsetHeight),
                  ...
                  i.hasClass("fix-top")
                    ? (i.css("margin-top", e.offsetTop + "px"),
                      (this.zIndex = this.options.max_index - e.index))
                    : i.hasClass("fix-bottom")
                    ? (i.css("margin-bottom", e.offsetBottom + "px"),
                      (this.zIndex = this.options.max_index - e.index))
                    : i.css({
                  ...
                  this.options.scrollMode
                    ? ((this.scrollPos >= a && i.hasClass("fix-top")) ||
                      (this.scrollPos <= a && i.hasClass("fix-bottom"))
                        ? (i.addClass("fixed"),
                  ...
                  i.is(".fixed.fix-top")
                    ? ((e.offsetTop += i[0].offsetHeight),
                      (Wolmart.sticky_top_height = e.offsetTop))
                    : i.is(".fixed.fix-bottom") &&
                      (e.offsetBottom += i[0].offsetHeight))
                : (i.parent().css("height", ""),
                  i
                    .removeClass("fixed")
                    .css({
              ...
              callbacks: {
                beforeClose: function () {
                  t("#hide-newsletter-popup")[0].checked &&
                    Wolmart.setCookie("hideNewsletterPopup", !0, 100);
                },
              },
            });
          }, 7500),
          ...
          (function () {
            function e() {
              s
                ...
                s.find(".compare-count").length > 1 &&
                  s.find("p:last-child").remove();
            }
            var a,
              i,
              o,
              ...
              Wolmart.$body
                .on("click", ".product .btn-compare", function (o) {
                  ...
                  (i = !1),
                    ...
                    setTimeout(function () {
                      r.removeClass("load-more-overlay loading"),
                        r
                          .toggleClass("w-icon-compare")
                          .toggleClass("w-icon-check-solid"),
                        r.attr("href", "compare.html"),
                        s.addClass("show");
                    }, 500);
    ...
    (Calendar.defaultOptions = {
      ...
      (Calendar.prototype.render = function (e, a) {
        ...
        for (h = d; h < d + 7; h++) {
          var u = t(
            "<th>" +
              this.settings.days[h % 7].substring(0, this.settings.dayExcerpt) +
              "</th>"
          );
        ...
        for (var p = l; p < c; p.setDate(p.getDate())) {
          for (var m = t("<tr></tr>"), h = 0; h < 7; h++) {
            ...
            p.toDateString() == new Date().toDateString() &&
