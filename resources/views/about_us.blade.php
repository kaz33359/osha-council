...
<head>
    ...
    <title>About - OSHA COUNCIL </title>
</head>
        ...
        <main id="content" class="site-main">
            ...
            <section class="about-section">
                <div class="container">
                    ...
                    <h2 class="about-title text-center">Introduction About OSHA Council</h2>
                    <div class="row">
                        <div style="padding-bottom: 20px;" class="col-md-6">
                            <p class="about-describe info-left">
                                OSHA Council stands out with the objective to assure safe and healthful working conditions for workers by setting and promoting American safety standards, and by providing outreach programs, education and assistance to the safety industry world over. With the increase in demand for American safety standards globally and recent development by OSHA DoL, OSHA Council has carved out the niche for Safety and Health following extensive research by safety professionals, training providers, employers and industry experts around the globe. 
                                <br>OSHA Council has repositioned its wide range of certifications with an aim to provide safety professionals with more comprehensive and valuable career support, endorsed by internationally recognized certification brands.                            
                            </p>
                        </div>
                        <div style="padding-bottom: 20px;" class="col-md-6">
                            <p class="about-describe info-right">
                                OSHA Council professional safety certifications allow candidates to learn new skills in specific industries and develop safety skills which measure competence, ability and performance. This helps to promote career development and provide a competitive edge for employees.
                                <br>
                                OSHA Council offers safety professionals a wide range of internationally recognized qualifications such as Diploma, Certificate & 30-hours OSHA Cards.                                                     
                                <br>Qualifications from OSHA Council are delivered through a network of OTCs (Outreach Training Centres) and ATs (Authorized Trainers). This network of OTCs & ATs ensure the training and examination processes in various disciplines is being delivered as per stringent guidelines set by OSHA Council.
                            </p>
                        </div>
...
Certificate in General Industry <br>
Certificate in Construction Industry <br>
Certificate in Safety, Health & Environment <br>
Certificate in Fire Safety <br>
Certificate in Oil & Gas
                    ...
                    <div class="about-banner">
                        <figure class="about-image figure-round-border">
                            <img src="{{asset('assets/img/construction2.jpg') }}" alt="">
                        </figure>
                        <div class="about-left-banner">
                            <div class="banner-icon">
                                <i aria-hidden="true" class="icon icon-trophy1"></i>
                            </div>
                            <h3>wide range of internationally recognized qualifications</h3>
                        </div>
                    </div>
                </div>
                </section>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'81c367c12a5b83f3',t:'MTY5ODMzMDcxMS44MjYwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/c359bc3d/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
