...
<head>
    ...
    <title>Fire & Safety – OSHA COUNCIL</title>
</head>
   <body>
                ...
                <div class="inner-baner-container" style="background-image: url(assets/img/educator-img12.jpg);">
                    <div class="container">
                        <div class="inner-banner-content">
                           <h1 class="inner-title">Fire and Safety</h1>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="single-page-section">
               <div class="container">
                  <figure class="single-feature-img">
                     <img style="width: 100%;" src="assets/img/FireSafety.jpg" alt="">
                  </figure>
                  <div class="page-content">
                     <h2>OSHA 30-hours for Fire and Safety</h2>
<p>
    Fire and Safety 30-hours by OSHA Council provides training through our outreach training centres (OTCs) and authorized trainers (ATs) worldwide.
<br>
<br>
30-hours International recognized Fire and Safety induction qualifications designed for entry-level workers to have Fire and safety awareness.
<br>
<br>
This qualification provides information on hazards, appropriate OSHA policies, procedures and principles to start their careers in the field of Fire and Safety.
<br>
<br>
This qualification is intended to provide an entry level Fire and Safety awareness on recognition and prevention of hazards at workplaces.  Students will be introduced to OSHA policies, procedures and standards as well as Fire safety and health principles and work practices covered in OSHA Act Part 1926.
<br>
<br>

Upon successful completion of the course, participants will receive an OSHA Wallet Card in Fire Safety 30-hours from OSHA Council within 6-8 weeks.
</p>
                    </div>
               </div>
            </div>
