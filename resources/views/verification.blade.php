...
<head>
    ...
    <title>Verification – OSHA COUNCIL</title>
</head>
                ...
                <div class="inner-baner-container" style="background-image: url(assets/img/educator-img12.jpg);">
                    <div class="container">
                        <div class="inner-banner-content">
                            <h1 class="inner-title">Verification</h1>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div class="row">
                                <div class="col-lg-8 offset-lg-2">
                                    <div class="career-section-head">
                                        ...
                                        <h2 class="section-title">Let's Join With Us !!</h2>
                            ...
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="vacancy-content">
                                                    ...
                                                    <p>Magna voluptatum dolorem! Dolores! Sociosqu commodo nobis imperdiet lacinia nobis.</p>
                                                    <a href="#" class="button-round-primary">APPLY NOW</a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="vacancy-content">
                                ...
                                <div class="col-lg-12">
                                    <div class="vacancy-form">
                                        <h4 class="form-title">CANDIDATE VERIFICATION FORM</h4>
                                        <form action="{{url('/certificate/validation')}}" method="POST">
                                            @csrf
                                            <p style="margin-left: 18px;">Unique Certificate Code :</p>
                                            <p>
                                                <input type="text" name="certificate_ID" placeholder="Enter unique ID*" required>
                                            </p>
                                            <p style="text-align: center;">
                                                <input type="submit" name="submit" style="width: 300px;">
                                            </p>
                                        </form>
                                        @if(session('result'))
                                        <div class="certificate-details-box">
                                            ...
                                            <ul>
                                                <li><strong>Certificate Code :</strong> {{ session('result')->certificate_code }}</li>
                                                <li><strong>Holder Name :</strong> {{ session('result')->holder_name }}</li>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'81c367d31b1c3c13',t:'MTY5ODMzMDcxNC40MDcwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/c359bc3d/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
