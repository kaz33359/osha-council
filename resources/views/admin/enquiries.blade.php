...
<head>
    ...
    <title>Osha Council | Enquiry</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/plugins/table/datatable/datatables.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('admin_assets/assets/css/forms/theme-checkbox-radio.css') }}">
    <link rel="stylesheet" type="text/css"
            ...
            <nav id="topbar">
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="index.html">
                            <img src="{{ asset('assets/img/educator-fabicon-300x300.png') }}" class="navbar-logo"
                                alt="logo">
                        </a>
                    </li>
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a
                                    href="javascript:void(0);">Enquiry</a></li>
                        </ol>
                    </nav>
                </div>
                                ...
                                <tbody>
                                    @foreach ($data as $list)
                                        <tr>
                                            ...
                                            <td>{{ $list->message }}</td>
                                            <td>
                                                <a href="{{ url('admin/enquiry/delete/') }}/{{ $list->id }}"
                                                        class="bs-tooltip" data-toggle="tooltip" data-placement="top"
                                                        title="" data-original-title="Delete Enquiry"><svg
