...
<head>
    ...
    <title>Certificate in Oil and Gas - OSHA COUNCIL</title>
</head>
                ...
                <div class="inner-baner-container" style="background-image: url(assets/img/educator-img12.jpg);">
                    <div class="container">
                        <div class="inner-banner-content">
                            <h1 class="inner-title">Certificate in Oil and Gas</h1>
                        </div>
                    </div>
                </div>
            </section>
                                ...
                                <div class="course-detail-container">
                                    <div class="course-description">
                                        ...
                                        <figure class="course-imgage figure-round-border">
                                            <img src="assets/img/oil2.jpg" alt="">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div id="pane-A" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="tab-A">
                                            ...
                                            <div id="collapse-A" class="collapse show" data-bs-parent="#nav-tab-content" role="tabpanel" aria-labelledby="heading-A">
                                                <div class="card-body">
                                                    ...
                                                    <p>
                                                        A Certificate in Oil and Gas is a specialized credential awarded to individuals who have successfully completed a comprehensive training program focused on the unique challenges and practices within the oil and gas industry. This certificate is designed to provide participants with the knowledge and skills necessary to navigate the complex landscape of oil and gas exploration, production, and related activities. The curriculum typically covers key aspects such as drilling operations, reservoir engineering, health and safety protocols specific to the industry, environmental considerations, and regulatory compliance. Participants may also learn about the economics of the oil and gas sector, risk management, and emerging technologies in the field. Given the inherent risks and complexities associated with the oil and gas industry, a Certificate in Oil and Gas is not only a testament to an individual's expertise but also serves as a valuable qualification for professionals seeking careers in exploration, extraction, and energy production. These certificate programs are often offered by specialized institutions, industry associations, or training providers closely linked to the oil and gas sector, contributing to the development of a skilled workforce capable of addressing the unique challenges posed by this critical industry.                                                    </p>
                                                    <h5>
                                                        Certificate in Oil and Gas Industry                                                    </h5>
                                                    <p>
                                                        Oil and Gas Industry Certificate by OSHA Council provides training through our outreach training centres (OTCs) worldwide.
                                                        <br>
                                                        Oil and Gas Industry certificate gives a better foundation for managers, supervisors and staff with Oil and Gas Industry safety among their day to day responsibilities at their workplaces.
                                                        <br>
                                                        OSHA Council certifications are globally recognized qualifications, widely taken as a first step towards a career in Oil and Gas Industry. This program develops ability to recognition, avoidance, abatement, and prevention of hazards related to oil and gas at workplaces.
                                                        <br>
                                                        <b>Upon successful completion of the course, participants will receive an Certificate in oil and gas operations from OSHA Council within 6-8 weeks.                                                    </p>
                                                        </b>
                                                    <h5>Certificate Course is divided into three Units:</h5>
                                                    <p><b>UNIT 1</b></p>
                                                    <ul>
                                                        <li>Occupational safety and Health (OSH) – Policy and Planning</li>
                                                        <li>Occupational safety and Health (OSH) – Organize and Implement</li>
                                                        <li>Occupational safety and Health (OSH) – Risk Assessment (JSA)</li>
                                                        <li>Occupational safety and Health (OSH) – Review and Improvement</li>
                                                        <li>Introduction to Oil and Gas Operations</li>
                                                        <li>Fire Risk Analysis</li>
                                                        <li>Hazardous Communication</li>
                                                        <li>Respiratory Protection</li><li>Rigging and Lifting Safety</li>
                                                        <li>Fire Hazard and Control</li>
                                                        <li>Combustible Dust Hazards and Controls</li>
