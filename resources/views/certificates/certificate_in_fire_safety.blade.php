...
<head>
    ...
    <title>Certificate in Fire & Safety - OSHA COUNCIL</title>
</head>
                ...
                <div class="inner-baner-container" style="background-image: url(assets/img/educator-img12.jpg);">
                    <div class="container">
                        <div class="inner-banner-content">
                            <h1 class="inner-title">Certificate in Fire Safety</h1>
                        </div>
                    </div>
                </div>
            </section>
                                ...
                                <div class="course-detail-container">
                                    <div class="course-description">
                                        ...
                                        <figure class="course-imgage figure-round-border">
                                            <img src="assets/img/fire2.jpg" alt="">
                                        </figure>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div id="collapse-A" class="collapse show" data-bs-parent="#nav-tab-content" role="tabpanel" aria-labelledby="heading-A">
                                                <div class="card-body">
                                                    ...
                                                    <p>
                                                        ...
                                                        A Certificate in Fire Safety is a credential awarded to individuals who have successfully completed a specialized training program focused on the principles and practices of preventing, managing, and responding to fire-related emergencies. This certificate is designed to equip participants with the knowledge and skills necessary to enhance fire safety in various settings, including residential, commercial, and industrial environments. The curriculum typically covers crucial aspects such as fire prevention measures, understanding fire behavior, use of fire safety equipment, emergency evacuation procedures, and compliance with relevant fire safety regulations. Participants learn to assess fire risks, implement preventive measures, and respond effectively in the event of a fire emergency. A Certificate in Fire Safety is particularly valuable for professionals in fields such as facility management, occupational health and safety, and emergency response. This credential not only signifies an individual's commitment to maintaining a safe environment but also demonstrates competence in mitigating fire-related risks. Certificate programs in fire safety are often offered by accredited institutions, training providers, or organizations specializing in fire safety education, contributing to the overall goal of creating safer and more resilient communities.                                                    </p>
                                                    <h5>
                                                        CERTIFICATION
                                                    </h5>
                                                    <p>
                                                        Fire and Safety Certificate by OSHA Council provides training through our outreach training centres (OTCs) worldwide.
<br>
Fire and Safety certificate gives a better foundation for managers, supervisors and staff with fire safety among their day to day responsibilities at their workplaces.
<br>
OSHA Council certifications are globally recognized qualifications, widely taken as a first step towards a career in Fire and Safety. This program develops ability to recognition, avoidance, abatement, and prevention of fire hazards at workplaces.
<br>
<b>Upon successful completion of the course, participants will receive an Certificate in Fire and Safety from OSHA Council within 6-8 weeks.
</b>                                                    </p>
...
<li>Introduction to Fire Safety Management</li>
